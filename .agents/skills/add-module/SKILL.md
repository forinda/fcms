...
<!-- Generated by `kick g agents` for forinda-cms. Edits are overwritten on the next refresh; keep customisation in a SKILL.local.md alongside. -->
...
5. Run `kick typecheck` and `pnpm run test` before claiming done.
