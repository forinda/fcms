...
export const Responsive = <T extends z.ZodTypeAny>(inner: T) =>
  z.union([inner, z.object({ base: inner, sm: inner.optional(), md: inner.optional(), lg: inner.optional(), xl: inner.optional() })])
...
export const StyleProps = z
  .object({
    ...
    padding: Responsive(z.union([Scale, z.object({ x: Scale.optional(), y: Scale.optional() })])).optional(),
