...
export function buildJsonLd(type: ContentType, entry: Entry, siteName: string): unknown | undefined {
...
export function pageSeo(
  spec: SiteSpec,
  page: { title: string; seo?: { title?: string; description?: string; image?: string; noindex: boolean }; draft: boolean },
