...
export function buildProgram(): Command {
  ...
  program
    .command("dev")
    .argument("[dir]", "spec directory", ".")
    // No default here, deliberately: an option with a default cannot be told
    // apart from one somebody typed, and `fcms.json` has to lose to the flag
    // and win over the built-in.
