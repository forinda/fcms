 ...
 */
import { isAlias, isCollection, isNode, isPair, isScalar, visit, type Document } from 'yaml'
...
export function checkProfile(doc: Document, locate: (offset?: number) => { line?: number; col?: number }): Diagnostic[] {
  const issues: Diagnostic[] = []
